...
from .openlanev2_subset_A_dataset import Original_OpenLaneV2_subset_A_Dataset, OpenLaneV2_subset_A_Dataset

@DATASETS.register_module()
class Original_OpenLaneV2_subset_B_Dataset(Original_OpenLaneV2_subset_A_Dataset):
...
@DATASETS.register_module()
class OpenLaneV2_subset_B_GraphicalSDMapDataset(OpenLaneV2_subset_B_Dataset):
